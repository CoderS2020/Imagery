...
function NavbarBootstrap() {
      ...
      return (
        <>
          <li className="nav-item" style={{ zIndex: "100" }}>
            <Link
              className="nav-link navLink about today"
              aria-current="page"
              to="/today"
            >
              &nbsp;&nbsp;Today
          ...
          <li className="nav-item" style={{ zIndex: "90" }}>
            <div className="nav-link  ">
              <div
                className="dropdown profilePicdropdown"
                style={{ zIndex: "10" }}
              >
                <a
                ...
                >
                  ...
                  profilephoto === null ? (
                    <img src={defaultLogo} className="defaultLogoSizing" />
                  ) : (
                    <img src={profilephoto} className="defaultLogoUserSizing" />
                  )}
                </a>
                <ul
                ...
                >
                  ...
                  <li>
                    <Link className="dropdown-item" to="/myuploads">
                      My uploads{" "}
                    </Link>
                  </li>
                  <li>
      ...
      return (
        <>
          <li className="nav-item">
            <Link
              className="nav-link navLink about"
              aria-current="page"
              to="/about"
            >
              <h1>About us</h1>
          ...
          <li className="nav-item">
            <a
              className="nav-link navLink signup"
          ...
          <li className="nav-item">
            <div
              className="nav-link navLink login"
  ...
  const postSignupData = async (e) => {
    ...
    if (res.status === 422 || !data) {
      ...
      window.alert(
        "An email has been sent to the entered email address,please verify."
      );
  ...
  return (
    <>
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <div className="input-group ">
              <span
                className="input-group-text search-bars placeicons1 mt-2"
                id="basic-addon1"
              >
                <HiSearch size={22} className="searchIcon" />
              </span>
              <input
                type="text"
                className="form-control placeicons search-bars mt-2"
                placeholder="Search something New ..."
                aria-label="Username"
                aria-describedby="basic-addon1"
                onChange={(e) =>
                  dispatch1({ type: "INPUT", payload: e.target.value })
                }
      ...
      <div>
        <button
          type="button"
          className="btn btn-primary hidebtn"
          ...
          <div className="modal-dialog ">
            <div className="modal-content" style={{ borderRadius: "10px" }}>
              <div className="modal-header">
                <h3 className="modal-title heading" id="exampleModalLabel">
                  Welcome to Imagery
                </h3>
                <button
                  type="button"
              ...
              <div className="modal-body">
                ...
                <form className="row g-3" method="POST">
                  ...
                  <div className="col-md-6 container orCss">OR</div>
                  ...
                  <p className="privacy">
                    ...
                    <Link to="/cookiesPolicy">Privacy policy.</Link>
                  </p>
                </form>
              </div>
            </div>
      ...
      <div>
        <button
          ...
          data-bs-toggle="modal"
          id="loginClick"
          data-bs-target="#exampleModalse"
          data-bs-whatever="@ft"
        ></button>

        <div
          className="modal fade xyz"
          id="exampleModalse"
          tabIndex="-1"
          aria-labelledby="exampleModalLabel"
          aria-hidden="true"
            ...
            <div className="modal-content" style={{ borderRadius: "10px" }}>
              ...
              <div className="modal-body" method="POST">
                <form className="row g-3">
                  ...
                  <div className="col-12">
                    <button
                      className="btn btn-primary submitBtn btnLogin "
                      type="submit"
                  ...
                  <p className="privacy">
                    By continuing, you agree to Imagery's{" "}
                    <Link to="/privacy">Terms of Service</Link>,{" "}
                    <Link to="/cookiesPolicy">Privacy policy</Link>.
                  </p>
      ...
      <div>
        <button
          ...
          className="btn btn-primary hidebtn"
          data-bs-toggle="modal"
          id="forgotPasswordClick"
          data-bs-target="#exampleModalsese"
          data-bs-whatever="@ft"
        ></button>
        ...
        >
          <div className="modal-dialog passwordModal">
            <div
              className="modal-content passwordModal"
              style={{ borderRadius: "10px" }}
            >
              <div className="modal-header">
                <h3
                  className="modal-title heading headingForgotPassword "
              ...
              <div className="modal-body" method="PUT">
                <form className="row g-3">
                  ...
                  <div className="col-12 ">
                    <button
                      className=" btnresetpassword btn btn-primary submitBtn  "
                      style={{ marginLeft: "59%" }}
                      type="submit"
