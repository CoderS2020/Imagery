            ...
            <div>
                ...
                <div className="col-md-12 termsFlex">
                    <ul className="nav col-md-2 flex-column ">
                        ...
                        <li class="nav-item">
                            <Link className="nav-link "  style={{color:"black"}} to="/privacy">Terms of Service</Link>
                        </li>
                        <li class="nav-item">
                            <Link className="nav-link " style={{textDecoration:"underline",color:"black"}} to="/cookiesPolicy">Privacy Policy & Cookies</Link>
                        </li>

                    </ul>
                    <div className="col-md-10">
                        <h1 className="termsofservice" >PRIVACY POLICY</h1>
                    </div>
                ...
                <div className="secondPart mb-3 ">
                    ...
                    <div className="col-md-6">
                        ...
                        Welcome to Imagery.
                        Imagery (“us”, “we”, or “our”) operates Imagery (hereinafter referred to as “Service”).
                        Our Privacy Policy governs your visit to Imagery, and explains how we collect, safeguard and disclose information that results from your use of our Service.
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Definitions</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                            <p>SERVICE means this website operated by Imagery.</p>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Information Collection and Use</h3></div>
                    <div className="col-md-6">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Types of Data Collected</h3></div>

                </div>

                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>Personal Data</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>Usage Data</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>Tracking Cookies Data</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>Other Data</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Use of Data</h3></div>
                    <div className="col-md-6 ">

                        <p>Imagery uses the collected data for various purposes:</p>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Retention of Data</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Transfer of Data</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                            ...
                            <p>Imagery will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Disclosure of Data</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>Disclosure for Law Enforcement.</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>Business Transaction.</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>Other cases. We may disclose your information also:</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Security of Data</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Your Data Protection Rights Under General Data Protection Regulation (GDPR) </h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h4 style={{ marginLeft: "92px" }}>What personal information we have about you. If you make this request, we will return to you:</h4></div>
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Service Providers</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >CI/CD tools</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Behavioral Remarketing</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Links to Other Sites</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Children’s Privacy</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    <div className="col-md-2"></div>
                    <div className="col-md-3 ml-2 "><h3 >Changes to This Privacy Policy</h3></div>
                    <div className="col-md-6 ">
                        <p className="privacyParagraph">
                ...
                <div className="secondPart mb-3">
                    ...
                    <div className="col-md-6 ">
                        <p className="privacyParagraph mb-5">
                        <p>If you have any questions , please contact through my Linkedin profile    </p>
                        </p>
                    </div>
