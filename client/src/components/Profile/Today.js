...
const Today = () => {
    ...
    let d = new Date();
    let time = String(String(d.getDate()) + String(d.getMonth()) + String(d.getFullYear()));
    var currentDate = time.trim();
    ...
    const todayPictures =images.filter((val)=>{
        ...
        return (
            ...
            <>
                {image.timeofUpload.includes(currentDate) ? <>
                    <div className={(
                        ...
                        <div className="ImageInformationFooter sameClass">
                            <div className="pinUrl">
                                ...
                                <div className="linkArrow">
                                    ...
                                    <div className="linkUrl">
                                        <a href={"https://" + image.destination} style={{ textDecoration: "none", color: "none" }} target="_blank">{image.destination}</a>
                                    </div>
                                </div>
                            ...
                            <div className="shareLink " >
                                ...
                                <div className="dropdown shareDropdown">
                                    <a className="dropdown-toggle" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="true">
